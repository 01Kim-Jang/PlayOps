...
| 구분 | 담당 | 역할 |
|------|------|------|
| 개발 | **장준호** ([@Junho73](https://github.com/Junho73)) | 플랫폼 전체 설계 및 구현, AI 연동, 자체 회귀 테스트, 인프라·배포, 산출물 문서 |
| 개발 | **윤재** ([@yoonjae](https://github.com/realyoon77)) | CI/CD 파이프라인 구축, LLM 공급자 구조 분리, AI 채팅 대화 히스토리 |
| 현업 검토 | 박희운 부장 | 테스트 서버 제공, 사용성 검토 및 개선 의견 제시 |
| 지도 | 지도교수 | 산출물 검토 및 방향 지도 |
